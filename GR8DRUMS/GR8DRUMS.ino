...
#define IRLED1 4278255360
#define IRLED2 4261543680
#define IRLED3 4177985280
#define IRLED4 4127850240
...
void loop() {
  ...
  if(abs(prevphotoValue-photoValue)>(PHOTOSENS))
  {
  Serial.print("f");
  ...
  if(abs(prevpot1Value-pot1Value)>(POT1SENS))
  {
  Serial.print("p");
  ...
  if(abs(prevpot2Value-pot2Value)>(POT2SENS))
  {
  Serial.print("k");
